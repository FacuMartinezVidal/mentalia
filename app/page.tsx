      ...
      >
        <Card className="overflow-y-auto border-none shadow-lg bg-white">
          ...
          <Image
            ...
            className="mx-auto"
          />
          <h1 className="text-3xl font-bold text-[#4a9e90]">¡Bienvenida, Martina!</h1>
          <p className="text-gray-700">
          Estás dando un gran paso hacia tu bienestar al iniciar este viaje.
          </p>
        </div>
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <h2 className="text-xl font-bold text-gray-800">Paso 1: Sentimientos y Relajación</h2>
              </div>
              <div>
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <h2 className="text-xl font-bold text-gray-800">Paso 2: Metas, Motivación y Apoyo</h2>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-700">
